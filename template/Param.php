...
<div class="box">
	...
	<p>
	<label for="lab_1">Veuillez saisir l'identifiant du compte</label>
	<input type='text' name='code' id='lab_1' value=''/>
	</p>
	
	<p>
	<label for="lab_2">Veuillez saisir votre mot de passe</label>
	<input name='password' id='lab_2' type='password' value=''/>
	</p>
